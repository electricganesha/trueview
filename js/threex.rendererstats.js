...
THREEx.RendererStats	= function (){
	...
	msDiv.style.cssText = 'padding:0 0 3px 3px;text-align:left;background-color:#FFF;';
	container.appendChild( msDiv );

	var msText	= document.createElement( 'div' );
	msText.style.cssText = 'color:#000;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:20px';
	...
	for(var i = 0; i < nLines; i++){
		...
		msTexts[i].style.cssText = 'color:#000;background-color:#FFF;font-family:Helvetica,Arial,sans-serif;font-size:13px;font-weight:bold;line-height:20px';
